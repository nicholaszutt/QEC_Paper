...
briefly introduce surface codes, and how they can be used to store quantum states.
...
\ref{fig:surface_code}. Computational states are stored in the \textit{data
  qubits} (open circles), whereas error detection and correction is done through
the \textit{measurement qubits} (solid circles). Qubits encoded in the surface
